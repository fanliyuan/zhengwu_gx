    ...
    function(e, t, n) {
      ...
      var r = n(8),
        ...
        a = function u(e) {
          ...
          if (!e)
            try {
              ...
              var f = new o({
                name: "CompileError",
                path: n,
                message: "template not found: " + v.message,
                stack: v.stack
              });
              if (t.bail) throw f;
              return s(f, t);
          ...
          return (
            (m.mappings = p.mappings),
            (m.sourcesContent = p.sourcesContent),
            (m.toString = function() {
              return p.toString();
            }),
            a && n && c.set(n, m),
        ...
        E = (function() {
          function e(t) {
            ...
            if (
              ...
              (this.scripts = []),
              (this.CONTEXT_MAP = {}),
              (this.ignore = [c, l, x].concat(i(t.ignore))),
              (this.internal = ((n = {}),
              r(n, v, "''"),
              r(n, d, "[0,0]"),
              r(n, g, "arguments[1]||{}"),
              ...
              r(s, m, [y, b, v, g]),
              s)),
              this.importContext(v),
              t.compileDebug && this.importContext(d),
              k)
            )
              try {
                w = E(w, t);
            ...
            (this.source = w),
              this.getTplTokens(w, t.rules, this).forEach(function(e) {
            ...
            s(e, [
              ...
              },
              {
                ...
                value: function() {
                  ...
                  var T = r.join("\n");
                  try {
                    var O = new Function(l, x, "return " + T)(s, e);
      ...
      var o = function(e, t) {
        for (
          ...
          for (
            ...
            if ("string" === f.type) {
              for (
                var h = void 0, m = 0, v = [], d = f.value;
                null !== (h = c.exec(d));

              )
                h.index > m &&
                  ((p = new i("string", d.slice(m, h.index), p)), v.push(p)),
                  (p = new i("expression", h[0], p)),
                  (h[0] = r(p)),
                  (p.script = a.use.apply(n, h)),
                  v.push(p),
                  (m = h.index + h[0].length);
              m < d.length && ((p = new i("string", d.slice(m), p)), v.push(p)),
                o.splice.apply(o, [l, 1].concat(v)),
                (l += v.length - 1);
            }
          }
        return o;
